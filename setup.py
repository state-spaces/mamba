...
USE_TRITON_ROCM = os.getenv("MAMBA_TRITON_AMD_ENABLE", "FALSE") == "TRUE"


@functools.lru_cache(maxsize=None)
def cuda_archs() -> str:
    return os.getenv("MAMBA_CUDA_ARCHS", "80;90;100;120").split(";")
...
if os.path.isdir(".git"):
    subprocess.run(["git", "submodule", "update", "--init", "csrc/selective_scan"], check=True)
