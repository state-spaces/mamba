...
model_name_str = model_name_str.replace("state-spaces/", "").replace("-", "_") + f"_{dtype_str}"
...
for bs in [2**i for i in range(8)]:
    ...
    df.to_csv(f"/home/ajassani/hipify_torch/experiment_t_bs_{model_name_str}.csv", index=False)
...
#     df = pd.DataFrame(data)
#     # Save the DataFrame as a CSV file
#     df.to_csv(f"/home/ajassani/hipify_torch/experiment_t_promptlen_{model_name_str}.csv", index=False)
...
#         df = pd.DataFrame(data)
#         # Save the DataFrame as a CSV file
#         df.to_csv(f"/home/ajassani/hipify_torch/experiment_t_promptlen_bs_matrix_{model_name_str}.csv", index=False)
...
#     df = pd.DataFrame(data)
#     # Save the DataFrame as a CSV file
#     df.to_csv(f"/home/ajassani/hipify_torch/experiment_t_promptlen_whileTrue_{model_name_str}.csv", index=False)
